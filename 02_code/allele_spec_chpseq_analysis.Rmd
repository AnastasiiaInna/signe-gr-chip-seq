...
12. Extract annoted count matrix for RASQUAL
...
14. Export only dex enriched results
...
write.csv2(dex.enrich.df, file = paste0(result.dir.fn, "dex_deseq_report_annotated_only_dex_echriched.csv"))

dex.enrich.anno.rasqual.df <- dex.enrich.df[,c(113, 12:106)] # take only geneID and sampleIDs
write.csv2(dex.enrich.anno.rasqual.df, file = paste0(result.dir.fn, "dex_deseq_anno_count_mtrx_for_rasqual_only_dex_e.csv"))
```
